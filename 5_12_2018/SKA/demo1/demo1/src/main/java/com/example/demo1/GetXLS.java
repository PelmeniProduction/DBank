...
**/
public class GetXLS {
    //метод считывания из .xls
    public static void readExcel() throws IOException {
        //создаём массив дат
        ArrayList<String> arDDate = new ArrayList<String>();
        //создаём массив значений
        ArrayList<Double> arD = new ArrayList<Double>();
        // Read XSL file
        FileInputStream inputStream = new FileInputStream(new File("C://downloadFolder/db/22.xls"));
    ...
    public static void getDataExcel() {
